...
tidy_models <- 
  ...
  map(~ mutate(.x, term = case_when(
    ...
    term == "black_n_btw_prop_traditional" ~ "%Black - TPS",
    term == "hispanic_n_btw_prop_traditional" ~ "%Hispanic - TPS",
  )))
...
tab <- huxreg(models, 
       coefs = c("Proximal threat" = "threat_overall",
                 "%Black(TPS)" = "black_n_btw_prop_traditional",
                 "%Hispanic(TPS)" = "hispanic_n_btw_prop_traditional"),
